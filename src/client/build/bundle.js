...
/***/ function(module, exports, __webpack_require__) {
	...
	window.socket_1 = new WebSocket("ws://0.0.0.0:4001");

	var ReactDOM = window.ReactDOM = __webpack_require__(2);
	var React = window.React = __webpack_require__(148);
	...
	var Main = __webpack_require__(160)(controller);
		    ...
		    render: function(){
		        return (
		        		React.createElement("div", null, 
			        		...
			        		React.createElement("div", {className: "sayhi", onClick: this.nudge}, "Say Hi"), 
			        		React.createElement("div", {className: "hictr"}, this.state.ctr)
		        		)
		        	)
		    }
		});
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "#app { font-family: 'sans-serif'; width: 400px; margin:50px auto; box-shadow: 0 0 5px rgba(0,0,0,0.4); padding:25px; text-align: center;}\n.sayhi {\n\theight: 100px;\n\twidth: 100px;\n\tline-height: 100px;\n\tbackground-color: green;\n\tcolor:#FFF;\n\ttext-align: center;\n\tborder-radius: 5px;\n\tfont-size: 1.2em; font-weight: bold;\n\tmargin:5px auto; \n}\n\n.nudge {\n\tanimation: nudge 0.3s;\n\tposition: relative;\n}\n\n@keyframes nudge {\n    0% {top:0px;}\n    50% {top:-5px;}\n    100% {top:0px;}\n}", ""]);
